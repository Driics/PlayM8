 ...
 * @param bind You need to call [ViewBindingT].bind static method to bind the view binding to fragment's view
 *
...
private class FragmentViewBindingDelegate<out ViewBindingT : ViewBinding>(
    ...
    override fun getValue(thisRef: Fragment, property: KProperty<*>): ViewBindingT =
        thisRef.requireView().getOrPutBinding(R.id.view_binding_tag)
